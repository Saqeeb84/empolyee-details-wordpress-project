...
class Digital_Advertising_Icon_Changer extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                        <div class="social-icon-search">
                              <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'digital-advertising'); ?>">
                        </div>
                        <?php
                        $digital_advertising_font_awesome_icon_array = digital_advertising_font_awesome_icon_array();
                        foreach ($digital_advertising_font_awesome_icon_array as $digital_advertising_font_awesome_icon) {
                              $icon_class = $this->value() == $digital_advertising_font_awesome_icon ? 'icon-active' : '';
                              echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($digital_advertising_font_awesome_icon).'"></i>
                                    <span class="icons-class">'.esc_attr($digital_advertising_font_awesome_icon).'</span>
                              </li>';
                        }
                        ?>
                  </ul>
...
function digital_advertising_customizer_script() {
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'digital_advertising_customizer_script' );

if(!function_exists('digital_advertising_font_awesome_icon_array')){
    function digital_advertising_font_awesome_icon_array(){
        return array("None", 
            "fab fa-500px",
