	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Digital_Advertising_Customize_Section_Pro(
				...
				array(
					'priority' => 9,
					'title'    => esc_html__( 'Digital Advertising Pro', 'digital-advertising' ),
					'pro_text' => esc_html__( 'Go Pro','digital-advertising' ),
					'pro_url'  => esc_url( 'https://www.themescaliber.com/themes/advertising-agency-wordpress-theme/' ),
				)
			)
		);
	}
