...
function digital_advertising_scripts() {
	...
	wp_enqueue_style( 'digital-advertising-block-style', esc_url(get_template_directory_uri()).'/css/block-style.css' );
	...
	wp_enqueue_script( 'digital-advertising-custom-jquery', esc_url(get_template_directory_uri()) . '/js/custom.js', array('jquery') );
